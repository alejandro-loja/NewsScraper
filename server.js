console.log("\n...Starting CNET Scraper");
var express = require("express");
var logger = require("morgan");
var mongoose = require("mongoose");
// get website
var axios = require("axios");
// jquery for website html
...
app.get("/scrape", function (req, res) {
  ...
  axios.get("https://www.cnet.com/news/").then(function (response) {
    ...
    $("section.dontMissRight").children().each(function (i, element) {
      // Save an empty result object
      var result = {};
      var block = $(element).children($("div", ".asset"));
      var title = block.find('h4').text().trim();
      var link = block.find('a').attr('href');
      link = 'https://www.cnet.com' + link
      var desc = block.find('.dek').text().trim();
